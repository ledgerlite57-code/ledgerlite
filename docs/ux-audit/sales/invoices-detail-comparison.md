# Screen Name: Invoices Detail

## 1. Current LedgerLite Capabilities
- Route: `/invoices/{id}`
- Screen file: `apps/web/app/(protected)/invoices/[id]/page.tsx`
- Permission checks in UI: `INVENTORY_NEGATIVE_STOCK_OVERRIDE`, `INVOICE_POST`, `INVOICE_WRITE`
- API endpoints referenced directly: `/accounts`, `/credit-notes`, `/invoices`, `/orgs/current`
