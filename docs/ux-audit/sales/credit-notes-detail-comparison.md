# Screen Name: Credit Notes Detail

## 1. Current LedgerLite Capabilities
- Route: `/credit-notes/{id}`
- Screen file: `apps/web/app/(protected)/credit-notes/[id]/page.tsx`
- Permission checks in UI: `INVOICE_POST`
- API endpoints referenced directly: `/orgs/current`
