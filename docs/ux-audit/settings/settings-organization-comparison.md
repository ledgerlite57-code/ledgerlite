# Screen Name: Settings Organization

## 1. Current LedgerLite Capabilities
- Route: `/settings/organization`
- Screen file: `apps/web/app/(protected)/settings/organization/page.tsx`
- Permission checks in UI: `COA_READ`, `ORG_READ`, `ORG_WRITE`
- API endpoints referenced directly: `/accounts`, `/orgs/current`, `/orgs/settings`
- HTTP methods referenced from this screen: `PATCH`
- UI capabilities detected: filterRow=False, savedViews=False, statusChip=True, form=True, fieldArray=False, lockDateWarning=False, attachments=False, dialog=False
- Workflow signals: update actions detected
