...
-- CreateEnum
CREATE TYPE "InventorySourceType" AS ENUM ('INVOICE', 'BILL', 'CREDIT_NOTE', 'DEBIT_NOTE', 'PURCHASE_ORDER_RECEIPT', 'INVOICE_VOID', 'BILL_VOID', 'CREDIT_NOTE_VOID', 'DEBIT_NOTE_VOID', 'ADJUSTMENT');
...
CREATE TABLE "OrgSettings" (
    ...
    "purchaseOrderApprovalThreshold" DECIMAL(18,2),
...
-- CreateIndex
CREATE INDEX "CreditNoteRefund_orgId_creditNoteId_idx" ON "CreditNoteRefund"("orgId", "creditNoteId");

-- CreateIndex
CREATE INDEX "CreditNoteRefund_orgId_customerId_refundDate_idx" ON "CreditNoteRefund"("orgId", "customerId", "refundDate");
...
-- CreateIndex
CREATE INDEX "PurchaseOrder_orgId_status_poDate_idx" ON "PurchaseOrder"("orgId", "status", "poDate");

-- CreateIndex
CREATE INDEX "PurchaseOrder_orgId_vendorId_poDate_idx" ON "PurchaseOrder"("orgId", "vendorId", "poDate");

-- CreateIndex
CREATE UNIQUE INDEX "PurchaseOrder_orgId_systemNumber_key" ON "PurchaseOrder"("orgId", "systemNumber");

-- CreateIndex
CREATE INDEX "PurchaseOrderLine_unitOfMeasureId_idx" ON "PurchaseOrderLine"("unitOfMeasureId");
...
-- CreateIndex
CREATE INDEX "Bill_orgId_purchaseOrderId_idx" ON "Bill"("orgId", "purchaseOrderId");
...
-- AddForeignKey
ALTER TABLE "CreditNoteRefund" ADD CONSTRAINT "CreditNoteRefund_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CreditNoteRefund" ADD CONSTRAINT "CreditNoteRefund_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Customer"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CreditNoteRefund" ADD CONSTRAINT "CreditNoteRefund_bankAccountId_fkey" FOREIGN KEY ("bankAccountId") REFERENCES "BankAccount"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CreditNoteRefund" ADD CONSTRAINT "CreditNoteRefund_paymentAccountId_fkey" FOREIGN KEY ("paymentAccountId") REFERENCES "Account"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CreditNoteRefund" ADD CONSTRAINT "CreditNoteRefund_createdByUserId_fkey" FOREIGN KEY ("createdByUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PurchaseOrderLine" ADD CONSTRAINT "PurchaseOrderLine_unitOfMeasureId_fkey" FOREIGN KEY ("unitOfMeasureId") REFERENCES "UnitOfMeasure"("id") ON DELETE SET NULL ON UPDATE CASCADE;
