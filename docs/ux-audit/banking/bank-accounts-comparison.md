# Screen Name: Bank Accounts

## 1. Current LedgerLite Capabilities
- Route: `/bank-accounts`
- Screen file: `apps/web/app/(protected)/bank-accounts/page.tsx`
- Permission checks in UI: `BANK_WRITE`
- API endpoints referenced directly: `/accounts`, `/bank-accounts`, `/orgs/current`
