# Screen Name: PDC Detail

## 1. Current LedgerLite Capabilities
- Route: `/pdc/{id}`
- Screen file: `apps/web/app/(protected)/pdc/[id]/page.tsx`
- Permission checks in UI: `PDC_POST`, `PDC_WRITE`
- API endpoints referenced directly: `/orgs/current`, `/pdc`
