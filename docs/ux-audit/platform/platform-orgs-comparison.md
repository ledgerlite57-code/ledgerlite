# Screen Name: Platform Orgs

## 1. Current LedgerLite Capabilities
- Route: `/platform/orgs`
- Screen file: `apps/web/app/(protected)/platform/orgs/page.tsx`
- Permission checks in UI: `PLATFORM_IMPERSONATE`, `PLATFORM_ORG_READ`, `PLATFORM_ORG_WRITE`
- API endpoints referenced directly: `/orgs/directory`
- HTTP methods referenced from this screen: none detected in route-level scan
- UI capabilities detected: filterRow=False, savedViews=False, statusChip=True, form=False, fieldArray=False, lockDateWarning=False, attachments=False, dialog=False
