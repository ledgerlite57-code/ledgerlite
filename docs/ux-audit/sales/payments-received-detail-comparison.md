# Screen Name: Payments Received Detail

## 1. Current LedgerLite Capabilities
- Route: `/payments-received/{id}`
- Screen file: `apps/web/app/(protected)/payments-received/[id]/page.tsx`
- Permission checks in UI: `PAYMENT_RECEIVED_POST`, `PAYMENT_RECEIVED_WRITE`
- API endpoints referenced directly: `/accounts`, `/orgs/current`, `/payments-received`
...
- Zoho supports customer-facing payment workflows with reminder automation.
...
As a accounts receivable accountant,
