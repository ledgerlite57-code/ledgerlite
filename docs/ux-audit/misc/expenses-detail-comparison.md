# Screen Name: Expenses Detail

## 1. Current LedgerLite Capabilities
- Route: `/expenses/{id}`
- Screen file: `apps/web/app/(protected)/expenses/[id]/page.tsx`
- Permission checks in UI: `EXPENSE_POST`, `EXPENSE_WRITE`
- API endpoints referenced directly: `/accounts`, `/expenses`, `/orgs/current`
