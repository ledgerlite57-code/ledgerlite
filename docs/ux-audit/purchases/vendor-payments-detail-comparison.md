# Screen Name: Vendor Payments Detail

## 1. Current LedgerLite Capabilities
- Route: `/vendor-payments/{id}`
- Screen file: `apps/web/app/(protected)/vendor-payments/[id]/page.tsx`
- Permission checks in UI: `VENDOR_PAYMENT_POST`, `VENDOR_PAYMENT_WRITE`
- API endpoints referenced directly: `/orgs/current`, `/vendor-payments`
